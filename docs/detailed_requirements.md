...
- Hỗ trợ upload file ảnh (PNG, JPEG, TIFF, BMP, WEBP) và PDF.
...
- Job đi qua các trạng thái: SUBMITTED → VALIDATING → QUEUED → DISPATCHED → PROCESSING → COMPLETED/PARTIAL_SUCCESS. Các nhánh lỗi: REJECTED, CANCELLED, FAILED, RETRYING, DEAD_LETTER.
